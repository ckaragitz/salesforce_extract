...
setup(
    ...
    description='Salesforce: Query, Save, Transform, and Put.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/OregonProject/SalesforceExtract',

    # Author details
    author='ckaragitz',
    author_email='ckaragitz@gmail.com',

    # What does your project relate to?
    keywords='salesforce API query csv sftp',
